...
module.exports = class Util {
    ...
    channelType(channel){
        if (channel.type === 'text' && guild.rulesChannel.id === channel.id) type = 'rules'
        else if (channel.type === 'store') type = 'store'
        else if (channel.type === 'text' && !channel.nsfw && !!!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'text'
        else if (channel.type === 'text' && channel.nsfw) type = 'nsfw_text'
        else if (channel.type === 'text' && !!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'private_text'
        else if (channel.type === 'news' && !channel.nsfw && !!!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'news'
        else if (channel.type === 'news' && channel.nsfw) type = 'nsfw_news'
        else if (channel.type === 'news' && !!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'private_news'
        else if (channel.type === 'voice' && !!!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'voice'
        else if (channel.type === 'voice' && !!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'private_voice'
        else if (channel.type === 'stage' && !!!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'stage'
        else if (channel.type === 'stage' && !!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'private_stage'
        else if (channel.type === 'public_thread' && !guild.channels.forge(channel.parentID).nsfw) type = 'public_thread'
        else if (channel.type === 'public_thread' && guild.channels.forge(channel.parentID).nsfw) type = 'nsfw_thread'
        else if (channel.type === 'private_thread' && guild.channels.forge(channel.parentID).nsfw) type = 'private_thread'
        else if (channel.type === 'news_thread' && guild.channels.forge(channel.parentID).nsfw) type = 'nsfw_news_thread'
        else if (channel.type === 'news_thread' && !guild.channels.forge(channel.parentID).nsfw) type = 'public_news_thread'
        else if (channel.type === 'news_thread' && !!channel.permissionOverwrites.filter(r => r.id === guild.roles.everyone.id).first()?.deny.toArray().includes('VIEW_CHANNEL')) type = 'private_news_thread'
    }
    /**
